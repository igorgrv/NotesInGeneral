...
3. Vous avez un ***bagage à main*** ?
4. Oui ! Un ordinateur, c'est ***tout***.
5. Voici votre carte d'embarquement. Bon ***voyage***.
6. Quel est votre vol ? - Le vol ***pour*** Paris.

## Classe 2.2

* Crie quatre phrases usando le verb avoir
  * J'ai un blouson;
  * Tu as un bonnet pour le froid? Il fait très froid;
  * On a un parapluie? il pleut;
  * Il a des bagages pour aller en France?
  * Nous mettons dans la valise des tee-shirts? On a des tee-shirts? il fait chaud
  * Vous avez de passeport pour aller en France? Nous avon des passeports, deux baggage à moin et nous avon aussi a fleur pour tu :)

* Complétez avec les pronoms sujets manquants (je, tu, il, elle, nous, vous, ils, elles) ou le verbe avoir conjugué.
  * J'**ai** un vol pour Paris.
     Dans ma valise, **J'**ai un pull et trois pantalons.
     Nous **avons** trois blousons dans la valise. **Vous** avez votre passeport, madame ?
     Ils **ont** cinq valises et deux bagages à main.
     Tu **as** un bonnet pour le froid ?
     Vous **avez** des bagages, monsieur ?
     Pour aller à Londres, elle **a** une valise et un ordinateur.

* Complétez avec **un**, **une**, **des**.
  * Pour aller en France, j'ai **une** valise et **un** bagage à main. Dans ma valise, j'ai **des** pulls et **des** pantalons. Je mets aussi **un** blouson pour le froid. J'ai mon passeport, mon check-in.... Je mets **une** écharpe et **une** bonnet : il pleut à Paris.
...
* Écrivez les phases:
  ...
  2. Tu as des valises;
  3. J'ai un passeport;
  4. Il a un vol pour Paris;
  5. On a des valises;
  6. Vous avez des bagages, Madame?
  7. Votre passeport, s'il vous plâit;
  8. Très bien, monsier
...
* Traduisez les phrases suivantes en portugais:
  ...
  * Bonjour, monsieur. Quel est votre vol ?
    * Bom dia, Senhor. Qual o seu vôo?
  *  J'ai un valise et un bagage à main;
    * Eu tenho uma mala e uma mala de mão;
  * Voici votre passeport et votre carte d'embarquement;
    * Aqui está o passaporte e o seu cartão de embarque;
  * Merci, messieurs, bon voyage!
    * Obrigado, senhores, boa viagem!
  * Ils ont un sac à dos et un ordinateur, c'est tout;
    * Eles tem uma mochila e um computador, é tudo;
...
* Dialogue:
  ...
  - Moi aussi, vous êtres française?
  	- Oui, vous aussi?
  - Non, moi Je suis Brésilien.
  	- J'aime le Brésil
  - J'aime la France
  	- Un café?
  - D'accord, merci. J'adore le Café.
