...
* O que é a SELIC?
  ...
  * Como é definido isso?
* O que é IPCA?
  * É o índice de inflação
* Boa líquidez diária?
  * Poupança? que podemos tirar a qualquer momento?
* CNPI?
  * É um analista de investimento, formado nisso, os youtubers não são
* P/VP
  * Preço sobre o valor patrimonial - se a empresa vale 1MM, se somar as ações teria que dar 1MM. Se o P/VP está abaixo de 1, então está com desconto.
* DY (Dividend Yield)
  * É quanto ela paga por ano; Se colocar 100 reais, e for DY 9,49% é o quanto ela irá pagar
  * Você recebe mesmo sem vender a ação
* BBAS**3** -> o que é o 3?
  * 
...
* Professor Mira - analista CNPI - Mira da
